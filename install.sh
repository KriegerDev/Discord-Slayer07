...
curl -LJO --remote-name --location https://github.com/KriegerDev/Slayer07API/archive/master.zip
...
curl -LJO --remote-name --location https://github.com/KriegerDev/Slayer07BaseWorker/archive/master.zip
...
curl -LJO --remote-name --location https://github.com/KriegerDev/SlayerBaseController/archive/master.zip
